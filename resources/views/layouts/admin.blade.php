        ...
        <div id="sidebar" class="sidebar fixed md:static inset-y-0 left-0 z-30 w-64 bg-white shadow-lg md:shadow-lg overflow-y-auto h-screen md:h-auto">
            ...
            <nav class="mt-6">
                ...
                <a href="{{ route('admin.branches.index') }}" 
                   class="flex items-center px-6 py-3 text-gray-700 hover:bg-gray-100 hover:text-primary {{ request()->routeIs('admin.branches.*') ? 'bg-primary text-white border-r-4 border-white' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
