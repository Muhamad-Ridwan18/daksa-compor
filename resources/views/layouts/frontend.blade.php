        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20">
                ...
                <div class="hidden md:flex items-center space-x-1">
                    ...
                    <a href="{{ route('about') }}" 
                       class="text-gray-700 hover:text-primary hover:bg-primary/5 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 {{ request()->routeIs('about') ? 'text-primary bg-primary/10' : '' }}">
                        Tentang
                    </a>
                    ...
                    <a href="{{ $waUrl }}" 
                       ...
                       class="bg-primary text-white hover:bg-opacity-90 px-6 py-2 rounded-lg text-sm font-semibold transition-all duration-300 hover:shadow-lg ml-2 flex items-center gap-2">
