    ...
    <nav class="bg-white sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20">
                ...
                <!-- Desktop Menu -->
                <div class="hidden md:flex items-center space-x-1 flex-nowrap">
                    <a href="{{ route('home') }}" 
                       class="text-gray-700 hover:text-primary hover:bg-primary/5 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 whitespace-nowrap {{ request()->routeIs('home') ? 'text-primary bg-primary/10' : '' }}">
                        Beranda
                    </a>
                    <a href="{{ route('about') }}" 
                       class="text-gray-700 hover:text-primary hover:bg-primary/5 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 whitespace-nowrap {{ request()->routeIs('about') ? 'text-primary bg-primary/10' : '' }}">
                        Tentang
                    </a>
                    <a href="{{ route('home') }}#services" 
                       class="text-gray-700 hover:text-primary hover:bg-primary/5 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 whitespace-nowrap">
                        Layanan
                    </a>
                    ...
                    <a href="{{ route('blog.index') }}" 
                       class="text-gray-700 hover:text-primary hover:bg-primary/5 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 whitespace-nowrap {{ request()->routeIs('blog.*') ? 'text-primary bg-primary/10' : '' }}">
                        Blog
                    </a>
                    ...
                    <a href="{{ route('documents.index') }}" 
                       class="text-gray-700 hover:text-primary hover:bg-primary/5 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 whitespace-nowrap {{ request()->routeIs('gallery.*') ? 'text-primary bg-primary/10' : '' }}">
                        Peraturan Pajak
                    </a>
                    ...
                    <a href="{{ route('careers.index') }}" 
                       class="text-gray-700 hover:text-primary hover:bg-primary/5 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 whitespace-nowrap {{ request()->routeIs('careers.*') ? 'text-primary bg-primary/10' : '' }}">
                        Karier
                    </a>
                    <a href="{{ $waUrl }}" 
                       @if($waNumber) target="_blank" rel="noopener" @endif
                       class="bg-primary text-white hover:bg-opacity-90 px-6 py-2 rounded-lg text-sm font-semibold transition-all duration-300 hover:shadow-lg ml-2 flex items-center gap-2 whitespace-nowrap flex-shrink-0">
