    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gradient-to-br from-gray-50 via-gray-100 to-gray-50">
        ...
        <div class="mb-8">
            <a href="/" class="inline-block transition-transform duration-300 hover:scale-105">
                <svg viewBox="0 0 316 316" xmlns="http://www.w3.org/2000/svg" class="w-24 h-24 fill-current text-[#D89B30]">
        ...
        <div class="w-full sm:max-w-md mt-6 px-8 py-10 bg-white shadow-xl overflow-hidden sm:rounded-2xl border border-gray-100">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="flex items-center justify-end mt-4">
                    ...
                    <button type="submit" 
                            class="ms-3 inline-flex items-center px-4 py-2 bg-[#D89B30] border border-transparent rounded-lg font-semibold text-sm text-white hover:bg-[#C88A20] focus:bg-[#C88A20] active:bg-[#B87A10] focus:outline-none focus:ring-2 focus:ring-[#D89B30] focus:ring-offset-2 transition ease-in-out duration-150">
                        {{ __('Log in') }}
                    </button>
                </div>
            </form>
