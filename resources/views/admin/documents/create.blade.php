        ...
        <form action="{{ route('admin.documents.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" id="slug" name="slug" value="{{ old('slug') }}"
                       ...
                       placeholder="Akan di-generate otomatis dari judul dokumen">
                <p class="mt-1 text-sm text-gray-500">Slug akan digunakan di URL. Kosongkan untuk auto-generate dari judul dokumen.</p>
                @error('slug')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div>
                ...
                <textarea id="meta_description" name="meta_description" rows="3" maxlength="500"
                          ...
                          placeholder="Deskripsi singkat untuk SEO (maksimal 500 karakter)">{{ old('meta_description') }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="document_type" name="document_type" value="{{ old('document_type') }}"
                ...
                <div class="flex gap-4 mb-4">
                    <label class="flex items-center">
                        <input type="radio" name="content_source" value="pdf" id="content_source_pdf" 
                               {{ old('content_source', 'pdf') === 'pdf' ? 'checked' : '' }}
                    ...
                    <label class="flex items-center">
                        <input type="radio" name="content_source" value="manual" id="content_source_manual"
                               {{ old('content_source') === 'manual' ? 'checked' : '' }}
                               class="h-4 w-4 text-primary focus:ring-primary border-gray-300"
                               onchange="toggleContentSource()">
            ...
            <div id="pdf_upload_section" class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">Format: PDF. Maksimal 10MB. Konten akan otomatis di-extract.</p>
                        @error('document_file')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="url" id="document_url" name="document_url" value="{{ old('document_url') }}"
            ...
            <div id="manual_html_section" class="hidden">
                <div>
                    ...
                    <textarea id="content_html" name="content_html" rows="20"
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-primary focus:border-primary @error('content_html') border-red-500 @enderror">{{ old('content_html') }}</textarea>
