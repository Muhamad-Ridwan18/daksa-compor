    ...
    <div class="bg-white rounded-xl shadow-lg p-8">
        <form action="{{ route('admin.documents.update', $document) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" id="slug" name="slug" value="{{ old('slug', $document->slug) }}"
            ...
            <div>
                ...
                <textarea id="meta_description" name="meta_description" rows="3" maxlength="500"
                          ...
                          placeholder="Deskripsi singkat untuk SEO (maksimal 500 karakter)">{{ old('meta_description', $document->meta_description) }}</textarea>
