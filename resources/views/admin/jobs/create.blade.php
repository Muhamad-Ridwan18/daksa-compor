...
<div class="bg-white rounded-lg shadow p-6">
    <form action="{{ route('admin.jobs.store') }}" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <textarea name="meta_description" rows="3" maxlength="500" class="w-full px-4 py-2 border rounded-lg focus:ring-primary focus:border-primary" placeholder="Deskripsi singkat untuk SEO (maksimal 500 karakter)">{{ old('meta_description') }}</textarea>
