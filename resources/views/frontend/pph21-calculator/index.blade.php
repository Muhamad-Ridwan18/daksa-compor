    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 py-8 sm:py-12 lg:py-16">
        <div class="max-w-4xl mx-auto text-center text-white">
            ...
            <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 leading-tight px-2">
                Kalkulator Pajak PPh 21 Masa
            </h1>
            
            <!-- Subtitle -->
            <p class="text-base sm:text-lg md:text-xl lg:text-2xl mb-6 sm:mb-8 text-white/90 max-w-3xl mx-auto px-4">
                Hitung Pajak Penghasilan Pasal 21 bulanan dengan mudah dan akurat sesuai peraturan terbaru 2024
            </p>
...
<div class="min-h-screen bg-gray-50 py-8 md:py-12" x-data="pph21Calculator()" x-init="init()">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 md:p-8">
                <h2 class="text-xl font-semibold text-gray-900 mb-6">Informasi Wajib Pajak</h2>
                
                <form id="pph21-calculator-form" @submit.prevent="calculate()">
                    <!-- Status Kawin -->
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            <label class="flex items-center p-3 border-2 rounded-lg cursor-pointer transition-all"
                                ...
                                <span class="text-sm font-medium">Tidak Kawin</span>
                            </label>
                            <label class="flex items-center p-3 border-2 rounded-lg cursor-pointer transition-all"
                                ...
                                <span class="text-sm font-medium">Kawin</span>
                            </label>
                            <label class="flex items-center p-3 border-2 rounded-lg cursor-pointer transition-all"
                                   :class="formData.status_kawin === 'HB' ? 'border-primary bg-primary/5' : 'border-gray-200 hover:border-gray-300'">
                                <input type="radio" x-model="formData.status_kawin" value="HB" class="sr-only" @change="debouncedCalculate()">
                                <span class="text-sm font-medium">Hidup Berpisah</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <label class="flex items-center p-3 border-2 rounded-lg cursor-pointer transition-all"
                                   :class="formData.tunjangan_pajak === 'gross' ? 'border-primary bg-primary/5' : 'border-gray-200 hover:border-gray-300'">
                                <input type="radio" x-model="formData.tunjangan_pajak" value="gross" class="sr-only" @change="debouncedCalculate()">
                                <div class="flex-1">
                                    <div class="font-medium text-sm">Gross</div>
                                    <div class="text-xs text-gray-500">Tunjangan PPh manual</div>
                                </div>
                            </label>
                            <label class="flex items-center p-3 border-2 rounded-lg cursor-pointer transition-all"
                                   :class="formData.tunjangan_pajak === 'gross-up' ? 'border-primary bg-primary/5' : 'border-gray-200 hover:border-gray-300'">
                                <input type="radio" x-model="formData.tunjangan_pajak" value="gross-up" class="sr-only" @change="debouncedCalculate()">
                                <div class="flex-1">
                                    <div class="font-medium text-sm">Gross-Up</div>
                                    <div class="text-xs text-gray-500">Tunjangan PPh otomatis</div>
                                </div>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="mb-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4">Komponen Penghasilan</h3>
                        
                        <!-- Gaji/Pensiun/THT/JHT -->
                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                                Gaji/Pensiun/THT/JHT
                            </label>
                            <div class="relative">
                                ...
                                <input 
                                    type="text" 
                                    name="gaji_pensiun_tht_jht"
                                    x-model="formData.gaji_pensiun_tht_jht"
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                ...
                                <input 
                                    type="text" 
                                    name="tunjangan_lainnya_lembur"
                                    x-model="formData.tunjangan_lainnya_lembur"
                                    class="currency-input w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                                    placeholder="0"
                                    @input="debouncedCalculate()"
                                >
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                ...
                                <input 
                                    type="text" 
                                    name="premi_asuransi"
                                    x-model="formData.premi_asuransi"
                                    class="currency-input w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                                    placeholder="0"
                                    @input="debouncedCalculate()"
                                >
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                ...
                                <input 
                                    type="text" 
                                    name="natura_kenikmatan"
                                    x-model="formData.natura_kenikmatan"
                                    class="currency-input w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                                    placeholder="0"
                                    @input="debouncedCalculate()"
                                >
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                ...
                                <input 
                                    type="text" 
                                    name="tantiem_bonus_gratifikasi"
                                    x-model="formData.tantiem_bonus_gratifikasi"
                                    class="currency-input w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                                    placeholder="0"
                                    @input="debouncedCalculate()"
                                >
                        ...
                        <!-- Tunjangan PPh (hanya untuk Gross) -->
                        <div class="mb-4" x-show="formData.tunjangan_pajak === 'gross'" x-transition>
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                                Tunjangan PPh
                            </label>
                            <div class="relative">
                                ...
                                <input 
                                    type="text" 
                                    name="tunjangan_pph"
                                    x-model="formData.tunjangan_pph"
                                    class="currency-input w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                                    placeholder="0"
                                    @input="debouncedCalculate()"
                                >
                        ...
                        <div class="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg" 
                             x-show="formData.tunjangan_pajak === 'gross-up'" 
                             x-transition>
                            <div class="flex items-start">
                                ...
                                <p class="text-sm text-blue-700">
                                    <strong>Metode Gross-Up:</strong> Tunjangan PPh akan dihitung otomatis oleh sistem sehingga Tunjangan PPh = PPh Terutang.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-primary/10 to-primary/5 rounded-lg p-6 mb-6">
                        <div class="space-y-4">
                            <div class="flex justify-between items-center">
                                ...
                                <span class="text-lg font-semibold text-gray-900" x-text="formatCurrency(result.penghasilan_bruto)"></span>
                            </div>
                            <div class="border-t border-primary/20 pt-4">
                                <div class="flex justify-between items-center mb-2">
                                    <span class="text-gray-600">PTKP</span>
                                    <span class="text-sm text-gray-500" x-text="getPTKPStatus()"></span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-600">Nilai PTKP</span>
                                    <span class="font-semibold text-gray-900" x-text="formatCurrency(result.ptkp)"></span>
                                </div>
                            </div>
                            <div class="border-t border-primary/20 pt-4">
                                <div class="flex justify-between items-center">
                            ...
                            <div class="border-t border-primary/20 pt-4">
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="font-semibold text-gray-900">
                                        <span x-text="formatTERPercent(result.ter_from_table)"></span>%
                                        <span class="text-sm text-gray-500 ml-1" x-text="'(' + result.kategori_ter + ')'"></span>
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="border border-gray-200 rounded-lg overflow-hidden">
                        ...
                        <div x-show="showDetails" x-transition class="p-4 space-y-3 bg-white">
                            <div class="flex justify-between text-sm">
                                <span class="text-gray-600">Penghasilan Neto</span>
                                <span class="font-medium text-gray-900" x-text="formatCurrency(result.penghasilan_neto)"></span>
                            </div>
                            <div class="flex justify-between text-sm">
                                <span class="text-gray-600">PKP (Penghasilan Kena Pajak)</span>
                                <span class="font-medium text-gray-900" x-text="formatCurrency(result.pkp)"></span>
                            </div>
                            <div class="flex justify-between text-sm">
                                <span class="text-gray-600">Tunjangan PPh</span>
                                <span class="font-medium text-gray-900" x-text="formatCurrency(result.tunjangan_pph)"></span>
                            </div>
                            <div x-show="formData.tunjangan_pajak === 'gross-up'" class="mt-2 p-2 bg-blue-50 rounded text-xs text-blue-700">
                                ℹ️ Tunjangan PPh dihitung otomatis (Gross-Up)
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center" data-aos="fade-up" data-aos-delay="400">
                @php
                    ...
                    $waText = 'Halo, saya tertarik dengan *Kalkulator PPh 21 Masa* dari ' . ($settings['company_name'] ?? 'Daksa') . '. Mohon informasi lebih lanjut.';
...
function pph21Calculator() {
    return {
        formData: {
            status_kawin: 'TK',
            tanggungan: 0,
            tunjangan_pajak: 'gross',
            gaji_pensiun_tht_jht: '',
            tunjangan_lainnya_lembur: '',
            honorarium: '',
            premi_asuransi: '',
            natura_kenikmatan: '',
            tantiem_bonus_gratifikasi: '',
            tunjangan_pph: ''
        },
        result: null,
        loading: false,
        ...
        init() {
            // Initialize currency formatting after a short delay to ensure DOM is ready
            this.$nextTick(() => {
                setTimeout(() => {
        ...
        async calculate() {
            ...
            if (!this.formData.status_kawin || this.formData.tanggungan === null || !this.formData.tunjangan_pajak) {
                return;
            }
            ...
            try {
                ...
                const data = {
                    ...
                    tunjangan_pajak: this.formData.tunjangan_pajak,
                    gaji_pensiun_tht_jht: this.unformatCurrency(this.formData.gaji_pensiun_tht_jht),
                    tunjangan_lainnya_lembur: this.unformatCurrency(this.formData.tunjangan_lainnya_lembur),
                    honorarium: this.unformatCurrency(this.formData.honorarium),
                    premi_asuransi: this.unformatCurrency(this.formData.premi_asuransi),
                    natura_kenikmatan: this.unformatCurrency(this.formData.natura_kenikmatan),
                    tantiem_bonus_gratifikasi: this.unformatCurrency(this.formData.tantiem_bonus_gratifikasi),
                    tunjangan_pph: this.unformatCurrency(this.formData.tunjangan_pph)
                };

                const response = await fetch('{{ route("pph21-calculator.calculate") }}', {
                    method: 'POST',
                    headers: {
                ...
                if (responseData.success) {
                    ...
                    // Auto-expand details on first calculation
                    if (!this.showDetails) {
        ...
        formatCurrency(value) {
            ...
            // Bulatkan ke integer (hilangkan desimal)
            num = Math.round(num);
            
            // Format integer dengan thousand separator (titik)
            const formattedInteger = Math.abs(num).toString().replace(/\B(?=(\d{3})+(?!\d))/g, '.');
            
            // Tambahkan tanda minus jika negatif
            const sign = num < 0 ? '-' : '';
            
            return 'Rp ' + sign + formattedInteger;
        },
        ...
        formatTERPercent(value) {
            ...
            // Format persentase TER (0.24 -> 24.00)
        ...
        getPTKPStatus() {
            if (!this.formData.status_kawin || this.formData.tanggungan === null) return '';
            const status = this.formData.status_kawin === 'TK' ? 'TK' : 'K';
            return `${status}${this.formData.tanggungan}`;
        }
    }
}
</script>
